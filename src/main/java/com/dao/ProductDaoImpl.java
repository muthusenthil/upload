   ...
   public void edit(ProductModel productmodel){
	...
	public void delete(String getId){
		...
		public List getAllProductModel(){
			return session.getCurrentSession().createQuery("from upload").list();
		}
		...
		public List getALLonear() {
			...
			return session.getCurrentSession().createQuery("from upload where category='onear'").list();
		...
		public List getALLoverear() {
			// TODO Auto-generated method stub
			return  session.getCurrentSession().createQuery("from upload where category='overear'").list();
		}

		@Override
		public List getALLbluetooth() {
			// TODO Auto-generated method stub
			return  session.getCurrentSession().createQuery("from upload where category='bluetooth'").list();
		}

		@Override
		public List getALLearbud() {
			// TODO Auto-generated method stub
			return  session.getCurrentSession().createQuery("from upload where category='earbud'").list();
		}
